...
#define GST_IS_VAAPI_PAD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_VAAPI_PAD))
#define GST_IS_VAAPI_PAD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_VAAPI_PAD))
...
#define GST_VAAPI_PAD_CAPS(pad) \
  (GST_VAAPI_PAD_CAST(pad)->caps)
#define GST_VAAPI_PAD_INFO(pad) \
  (&GST_VAAPI_PAD_CAST(pad)->info)
#define GST_VAAPI_PAD_BUFFER_POOL(pad) \
  (GST_VAAPI_PAD_CAST(pad)->buffer_pool)
#define GST_VAAPI_PAD_ALLOCATOR(pad) \
  (GST_VAAPI_PAD_CAST(pad)->allocator)
#define GST_VAAPI_PAD_BUFFER_SIZE(pad) \
  (GST_VAAPI_PAD_CAST(pad)->buffer_size)
#define GST_VAAPI_PAD_ALLOWED_RAW_CAPS(pad) \
  (GST_VAAPI_PAD_CAST(pad)->allowed_raw_caps)
#define GST_VAAPI_PAD_CAPS_IS_RAW(pad) \
  (GST_VAAPI_PAD_CAST(pad)->caps_is_raw)
...
#define GST_IS_VAAPI_SINK_PAD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_VAAPI_SINK_PAD))
#define GST_IS_VAAPI_SINK_PAD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_VAAPI_SINK_PAD))
...
#define GST_IS_VAAPI_SRC_PAD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_VAAPI_SRC_PAD))
#define GST_IS_VAAPI_SRC_PAD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_VAAPI_SRC_PAD))
