 ...
 * @GST_VAAPI_DRIVER_QUIRK_MISSING_DECODER_FORMATS: if driver does not
 *   report all the derive images download for decoders (NV12 & YV12).
 */
typedef enum
{
  ...
  GST_VAAPI_DRIVER_QUIRK_MISSING_DECODER_FORMATS = (1U << 5),
} GstVaapiDriverQuirks;
