...
gst_vaapi_encoder_mpeg2_class_init (GstVaapiEncoderMpeg2Class * klass)
{
   ...
   */
  g_object_class_install_property (object_class, ENCODER_MPEG2_PROP_RATECONTROL,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_MPEG2_PROP_TUNE,
  ...
  g_object_class_install_property (object_class, ENCODER_MPEG2_PROP_QUANTIZER,
      g_param_spec_uint ("quantizer",
          "Constant Quantizer",
          "Constant quantizer (if rate-control mode is CQP)",
          2, 62, 8, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));

  g_object_class_install_property (object_class, ENCODER_MPEG2_PROP_MAX_BFRAMES,
