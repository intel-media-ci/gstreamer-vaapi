...
static void
gst_vaapi_encoder_jpeg_finalize (GObject * object)
{
...
gst_vaapi_encoder_jpeg_class_init (GstVaapiEncoderJpegClass * klass)
{
  ...
  object_class->finalize = gst_vaapi_encoder_jpeg_finalize;

  g_object_class_install_property (object_class, ENCODER_JPEG_PROP_RATECONTROL,
  ...
  g_object_class_install_property (object_class, ENCODER_JPEG_PROP_TUNE,
  ...
  g_object_class_install_property (object_class, ENCODER_JPEG_PROP_QUALITY,
