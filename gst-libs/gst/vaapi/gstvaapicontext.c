...
context_destroy (GstVaapiContext * context)
{
  ...
  context_id = GST_VAAPI_CONTEXT_OBJECT_ID (context);
  ...
  if (context_id != VA_INVALID_ID) {
    ...
    GST_VAAPI_CONTEXT_OBJECT_ID (context) = VA_INVALID_ID;
  }
...
context_create (GstVaapiContext * context)
{
  ...
  GST_DEBUG ("context 0x%08x", context_id);
  GST_VAAPI_CONTEXT_OBJECT_ID (context) = context_id;
  success = TRUE;
...
gst_vaapi_context_get_id (GstVaapiContext * context)
{
  ...
  return GST_VAAPI_CONTEXT_OBJECT_ID (context);
}
