...
gst_vaapi_encoder_h265_class_init (GstVaapiEncoderH265Class * klass)
{
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_RATECONTROL,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_TUNE,
   ...
   * This is available only on CQP mode.
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_QP_IB,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_NUM_SLICES,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_CPB_LENGTH,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_MBBRC,
   ...
   */
  g_object_class_install_property (object_class, ENCODER_H265_PROP_LOW_DELAY_B,
