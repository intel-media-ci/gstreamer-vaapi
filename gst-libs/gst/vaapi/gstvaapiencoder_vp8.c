...
gst_vaapi_encoder_vp8_class_init (GstVaapiEncoderVP8Class * klass)
{
  ...
  g_object_class_install_property (object_class, ENCODER_VP8_PROP_RATECONTROL,
  ...
  g_object_class_install_property (object_class, ENCODER_VP8_PROP_TUNE,
  ...
  g_object_class_install_property (object_class,
      ENCODER_VP8_PROP_SHARPNESS_LEVEL, g_param_spec_uint ("sharpness-level",
          "Sharpness Level", "Controls the deblocking filter sensitivity", 0, 7,
          DEFAULT_SHARPNESS_LEVEL,
          G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_CONSTRUCT |
          G_PARAM_FLAG_VAAPI_ENCODER_EXPOSURE));

  g_object_class_install_property (object_class, ENCODER_VP8_PROP_YAC_Q_INDEX,
